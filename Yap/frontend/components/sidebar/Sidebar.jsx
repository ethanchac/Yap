...
function Sidebar() {
    ...
    return (
        ...
        >
            {/* Yapp Logo Section */}
            <div className="mb-4 sm:mb-6 md:mb-8 pb-3 sm:pb-4 md:pb-6 border-b border-gray-700 flex-shrink-0">
                <Link to="/home" className="flex items-center justify-center">
                    <h1 className="text-white text-2xl sm:text-3xl md:text-4xl font-bold">Yapp.</h1>
                </Link>
            </div>
            ...
            <ul className="flex-1 flex flex-col justify-evenly min-h-0">
                <li>
                    <Link 
                        to="/home" 
                        className={`flex items-center space-x-2 sm:space-x-3 md:space-x-4 w-full px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 text-white text-sm sm:text-base md:text-lg rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 ${
                            isActive('/home') 
            ...
            <div className="mt-3 sm:mt-4 md:mt-6 pt-3 sm:pt-4 md:pt-6 border-t border-gray-700 flex-shrink-0">
                <Link 
                    to="/create" 
